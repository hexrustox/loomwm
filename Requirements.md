...
| **8** | **Customizable Touchpad Gestures**         | The system SHOULD allow users to bind custom actions (e.g., switch workspace, move focus) to multi-finger touchpad gestures.                                                                                           |
| **9** | **Customizable Window Border**             | The system MUST allow users to customize the appearance of the window border, including its thickness and color. The system MUST support rounded corners (border radius).                                              |
